...
- If the processing_instructions ask to write software: You must write all the program code in the (#output) using the language comments to write any needed explanation in the (#output). Ensure that the whole (#output) is runnable in the target language. 
# Response template:
{""}(#output)
