...
'echo "Julia has one dog and Cecilia has one cat and also one dog" | tulp change all the occurrences of dog to parrots'
'echo "Julia has one dog and Cecilia has one cat and also one dog" | tulp make a python program that plots the number of pets each has using mathplotlib, stacking by type | python'
...
'tulp write a paragraph of a story about Alice, Bob finding 10 oranges and sharing them rite a story about Alice, Bob and Joe, they will find 10 oranges, 10 apples and 10 bananas | tee /tmp/story.txt'
